...
| **[Kontrakt apky](docs/apka-kontrakt.md)** | dva kanály (autorský a prezentační), `AppBackend`, rukojeť instance pro volání odjinud, kurzor u snapshotu, chování při výpadku, připnutí klientského modulu otiskem |
